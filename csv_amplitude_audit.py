def csv_filter(file_name = "FordPass & Lincoln Way [Live]_events_2025-06-09T17_55_51.078+00_00.csv"):
    import pandas as pd
    ...
    strict_event_rows = df[
        ...
        (
        (df["Event Activity"].str.upper() == "ACTIVE") if "Event Activity" in df.columns else False
        ) | (
